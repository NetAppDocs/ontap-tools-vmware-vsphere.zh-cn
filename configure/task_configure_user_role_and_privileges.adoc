...
** 访问System Manager
+
有关如何从 Web-CLI 下载 ONTAP Privileges 文件的说明，请参见知识库文章 - https://kb.netapp.com/mgmt/OTV/Virtual_Storage_Console/Virtual_Storage_Console%3A_How_to_retrieve_the_JSON_file_to_configure_user_roles_and_privileges["Virtual Storage Console：如何检索JSON文件以配置用户角色和权限"^]。
