...
如果您要部署最新版本的ONTAP 工具、则必须查看相关主题 link:..deploy/concept_requirements_for_deploying_ontap_tools_for_vmware_vsphere.html["部署 ONTAP 工具的要求"]。主题 link:../deploy/task_upgrade_to_the_9_8_ontap_tools_for_vmware_vsphere.html["升级到最新版本的 ONTAP 工具"] 具有有关执行原位升级的信息。
