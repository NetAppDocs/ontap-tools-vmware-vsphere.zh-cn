...
以下文章介绍了在启用 VCF 时向 ONTAP tools 添加存储的过程 https://kb.netapp.com/mgmt/OTV/SRA/Storage_Replication_Adapter%3A_How_to_configure_SRA_in_a_SRM_Shared_Recovery_Site["通过Swagger-UI将存储添加到ONTAP工具"^]。
